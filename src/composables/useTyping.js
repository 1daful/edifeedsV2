...
export function useTyping(currentUserId) {
    ...
    function ensureChannel(matchId) {
        ...
        channel
            ...
            const othersTyping = Object.entries(state)
                ...
                .some(([, clients]) => clients.some(c => c.isTyping === true && c.typingIn === matchId));
    ...
    onBeforeUnmount(() => {
        for (const matchId of channels.keys())
