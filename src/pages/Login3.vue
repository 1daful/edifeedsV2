<template>
  ...
  @submit="handleLogin"
>
<q-input v-model="testEmail" label="Test Email" />
...
<Field name="email" v-slot="{ value, errorMessage, handleChange, handleBlur }">
  <q-input
    :model-value="value"
...
const formMode = ref('login') // 'login', 'register', 'forgot'
