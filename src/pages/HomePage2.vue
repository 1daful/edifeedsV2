<template>
  <q-page class="elegant-home-page">
    ...
    <div class="main-content">
      ...
      <DailyInspirations :devotional="dailyDevotional" :quote="dailyQuote" :song="dailySong"></DailyInspirations>
...
import MediaTypes from "../components/Home/MediaTypes.vue";
...
import TopContributor from '../components/Home/TopContributor.vue';
...
const topics = ref([
  ...
  },
  {
    ...
    icon: 'spa',
    image: 'https://source.unsplash.com/800x450?peace',
    slug: 'peace'
  }
])
...
type TrendingItem = {
  id: number
  title: string
  type: 'music' | 'video' | 'book' | 'quote'
  duration: string
  cover: string
}

const popularItems = ref<TrendingItem[]>([
  {
    id: 1,
