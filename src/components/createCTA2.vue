...
const stats = ref([
  ...
  { value: 2.4, suffix: 'M', label: 'Content Pieces' },
...
const features = ref([
  {
    icon: 'create',
    title: 'Easy Creation',
    description: 'Intuitive tools to bring your ideas to life effortlessly'
  },
  {
    icon: 'group',
    title: 'Community Focus',
    description: 'Connect with like-minded creators and grow together'
  },
  {
    icon: 'trending_up',
    title: 'Growth Analytics',
    description: 'Track your impact and optimize your content strategy'
  }
]);
